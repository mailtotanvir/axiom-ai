...
check "gateway /metrics"     "http://$HOST:3000/metrics" 'http_server_request_duration_seconds'
check "rag-pipeline /metrics" "http://$HOST:8000/metrics" 'http_server_request_duration_seconds'
check "agent-runtime /metrics" "http://$HOST:5000/metrics" 'http_server_request_duration_seconds'
check "ops-observability /metrics" "http://$HOST:14000/metrics" 'http_server_request_duration_seconds'
